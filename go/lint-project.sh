...
if [[ "$OS_NAME" != "windows" ]]; then
    ...
    enabled="-E=asciicheck,bidichk,bodyclose,durationcheck,errchkjson,exhaustive,exportloopref,forcetypeassert,gosec,misspell,nolintlint,rowserrcheck,sqlclosecheck,thelper,unparam,unused,usestdlibvars,wastedassign"
