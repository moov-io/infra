...
if [[ "$TRAVIS_OS_NAME" == "linux" ]]; then wget -q -O ./bin/nancy https://github.com/sonatype-nexus-community/nancy/releases/download/v0.2.6/nancy-linux.amd64-v0.2.6; fi
if [[ "$TRAVIS_OS_NAME" == "osx" ]]; then wget -q -O ./bin/nancy https://github.com/sonatype-nexus-community/nancy/releases/download/v0.2.6/nancy-darwin.amd64-v0.2.6; fi
if [[ "$TRAVIS_OS_NAME" != "windows" ]]; then
    chmod +x ./bin/nancy
